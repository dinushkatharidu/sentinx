        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="space-y-8">
                <div class="bg-gray-800 p-6 rounded-lg border border-gray-700 shadow-xl">
                    <h3 class="text-xl font-bold mb-4 text-blue-400 border-b border-gray-700 pb-2 uppercase tracking-tight">Target Profile</h3>
                    ...
                    <div class="mb-6">
                        @if($target->image)
                            <div class="relative group">
                                ...
                                <div class="absolute bottom-2 right-2 bg-blue-600 text-[10px] px-2 py-1 rounded font-bold uppercase">
                                    Verified Evidence
                                </div>
                            </div>
                        @else
                            <div class="w-full h-48 bg-gray-900 flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-700 text-gray-600">
                    ...
                    <div class="space-y-4">
                        <p>
                            <span class="text-gray-500 block text-[10px] uppercase tracking-widest font-bold">Full Name</span>
                            <span class="text-lg font-semibold text-white">{{ $target->name }}</span>
                        </p>
                        <p>
                            <span class="text-gray-500 block text-[10px] uppercase tracking-widest font-bold">Handle / Username</span>
                            <span class="text-lg text-blue-300">{{ $target->username ?? 'Unknown' }}</span>
                        </p>
                        <p>
                            <span class="text-gray-500 block text-[10px] uppercase tracking-widest font-bold">Primary Email</span>
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-gray-800 p-6 rounded-lg border border-blue-900/30 shadow-xl">
                    <h3 class="text-xl font-bold mb-4 text-green-400 border-b border-gray-700 pb-2 uppercase tracking-tight">Automated Intelligence Gathering</h3>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                        ...
                        <a href="https://www.linkedin.com/search/results/all/?keywords={{ urlencode($target->name) }}" target="_blank"
                            class="flex items-center justify-between p-4 bg-gray-900/50 hover:bg-blue-900/40 rounded-lg transition border border-gray-700">
                ...
                <div class="bg-gray-800 p-6 rounded-lg border border-gray-700 shadow-xl">
                    <h3 class="text-xl font-bold mb-4 text-yellow-500 border-b border-gray-700 pb-2 uppercase tracking-tight">Investigation Log</h3>
                    ...
                    <div class="space-y-4 max-h-100 overflow-y-auto pr-2">
                        @forelse ($target->activities->reverse() as $activity)
                            <div class="p-4 bg-gray-900/40 border-l-4 border-yellow-600 rounded-r-lg">
                                ...
                                <span class="text-[10px] text-gray-500 mt-2 block uppercase tracking-tighter">{{ $activity->created_at->diffForHumans() }}</span>
                            </div>
                        @empty
                            <p class="text-center text-gray-600 py-10 italic">No activities logged for this target yet.</p>
                        @endforelse
                    </div>
                </div>
