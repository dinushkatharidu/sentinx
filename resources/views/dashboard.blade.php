...
<head>
    ...
    <title>Command Center - SentinX</title>
                    ...
                    @forelse($recent_activities as $activity)
                        <div class="bg-[#0b1120] p-4 rounded border border-gray-800 flex justify-between items-center group hover:border-blue-500/30 transition">
                            ...
                            <div class="opacity-0 group-hover:opacity-100 transition">
                                <a href="{{ route('targets.show', $activity->target->id) }}" class="text-blue-500 hover:text-blue-400 p-2">
            ...
            <div class="lg:col-span-4 space-y-6">
                <div class="bg-[#111827] p-6 rounded-lg border border-gray-800 shadow-xl">
                    ...
                    <div class="space-y-3">
                        ...
                        <button onclick="runOperation('Master Intelligence Report')" class="w-full bg-[#0b1120] border border-gray-800 p-3 rounded text-left text-[10px] font-mono hover:border-blue-500/50 hover:bg-[#111827] transition flex items-center group">
